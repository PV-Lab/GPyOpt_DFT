...
This is a fork of GPyOpt package [GPyOpt homepage](http://sheffieldml.github.io/GPyOpt/). A new constrained acquisition function utilizing DFT data, EI_DFT, has been added to the package. This acqusition function is designed to be used for optimizing ternary MAPbI/FAPbI/CsPbI perovskite mixtures. The description of the original GPyOpt repository follows.
